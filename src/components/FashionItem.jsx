      ...
      <div className="w-11/12 sm:w-10/12 lg:w-9/12 mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-0">
          ...
          <div className="text-center lg:text-left">
            <h2 className="text-[#151875] font-josefin text-[20px] sm:text-[22px] font-bold mb-2">
          ...
          <div className="flex flex-wrap justify-center sm:justify-end items-center gap-4 sm:gap-6">
            ...
            <div className="flex items-center gap-2">
              <label className="text-[#3F509E] font-lato text-[14px] sm:text-[16px]">
                Per Page:
              </label>

              <input
                type="text"
                className="w-14 h-6 border border-[#E7E6EF] outline-none px-2 text-[#8A8FB9] text-[12px]"
              />
            </div>

            {/* View Toggle */}
            <div className="flex items-center gap-2">
              <span className="text-[#3F509E] font-lato text-[14px] sm:text-[16px]">
                View:
              </span>
