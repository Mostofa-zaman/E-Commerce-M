    ...
    <div className='flex flex-col gap-8 sm:gap-10'>
      {blogs.map((blog) => (
        <div key={blog.id} className="group">
          ...
          <div className="w-full h-[220px] sm:h-[320px] md:h-[380px] lg:h-[453px] rounded-md overflow-hidden mb-4 sm:mb-6">
            <img
              src={blogM}
              alt={blog.title}
          ...
          <h3 className="font-josefin text-[18px] sm:text-[22px] md:text-[26px] lg:text-[30px] font-bold text-[#151875] mb-3 sm:mb-4 leading-tight">
            {blog.title}
          </h3>

          <p className="font-lato text-[14px] sm:text-[15px] lg:text-[16px] text-[#8A8FB9] leading-6 sm:leading-7 mb-4 sm:mb-6 text-justify">
            {blog.desc}
          </p>

          <div className="flex items-center gap-2 cursor-pointer group-hover:text-[#FB2E86] transition-colors w-fit">
            <span className="font-lato text-[15px] sm:text-[16px] lg:text-[18px] font-bold text-[#151875] group-hover:text-[#FB2E86]">
              Read More
            </span>
